...
class ShallowNet:
    '''
        ...
        Shallow Neural Network in Keras
            ...
            of 28x28 pixel images that contain handwritten images.
    ...
    def make_model(self):
        ...
        out_classes = 10
        learning_rate = 0.01
        model.add(Dense(layer_1_neurons, activation='sigmoid', input_shape=(self.num_pixels,)))
    ...
    def run(self):
        self.model.fit(self.train_data.x, self.train_data.y, batch_size=128, epochs=2,
                  verbose=1, validation_data=(self.test_data.x, self.test_data.y))
