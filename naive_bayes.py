...
def crossValidate(trainM, outFile):
	...
	for perc in ps:
		...
		for i in range(numChecks):
			...
			avgBase = avgBase + bl
		avgZ1Loss = avgZ1Loss/float(numChecks); avgBase = avgBase/float(numChecks); avgSqLoss = avgSqLoss/float(numChecks)
		percs.append((100*perc) ); ts.append(frac); z1losses.append(avgZ1Loss); slosses.append(avgSqLoss); base.append(bl)
